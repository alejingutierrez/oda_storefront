...
- 2026-01-25 | MC-086 | done | Progreso incremental product-enrichment (no drain en run) | Docker rebuild ok; servicios healthy; Vercel prod OK: https://oda-storefront-6ee5-8g2lo89i7-alejingutierrezs-projects.vercel.app (runtime logs sin eventos).
