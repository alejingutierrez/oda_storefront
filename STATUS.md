...
Registros:
- 2026-01-20 | MC-036 | done | Directorio admin de marcas con cards 3x5, modal de detalle, CRUD y filtros/paginación; API CRUD brands | Docker rebuild: falló (daemon apagado); Vercel prod OK: https://oda-storefront-6ee5-mm3se5e1p-alejingutierrezs-projects.vercel.app
