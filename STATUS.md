...
Registros:
- 2026-01-20 | MC-037 | done | Resiliencia scraping admin: re‑encola jobs atascados, auto‑resume tras recarga, /admin/brands separado de /admin/brands/scrape y menú lateral | Docker rebuild: pendiente (daemon apagado); Vercel: pendiente verificación
