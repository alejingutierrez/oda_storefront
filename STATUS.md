...
Registros:
- 2026-01-23 | MC-073 | done | Drain serverless catálogo con cron Vercel | Build local OK (env); Vercel prod OK: https://oda-storefront-6ee5-nv5hzsxqf-alejingutierrezs-projects.vercel.app (logs sin eventos).
