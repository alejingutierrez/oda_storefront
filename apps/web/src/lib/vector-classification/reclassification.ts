 ...
 * 1. Compute cosine distance to every centroid (subcategory or gender).
 ...
 *
 * @param modelType - "subcategory" or "gender"
 * @param options   - Thresholds and batch configuration.
...
async function scanSubcategories(
  ...
  while (true) {
    ...
    // Compute distances to all subcategory centroids for this batch
...
export async function acceptSuggestion(
  ...
  // Optionally add to ground truth
  if (addToGroundTruth && suggestion.toSubcategory && suggestion.toCategory) {
