...
- Taxonomy remap (auto-reseed): `TAXONOMY_REMAP_AUTO_RESEED_ENABLED`, `TAXONOMY_REMAP_AUTO_RESEED_THRESHOLD`, `TAXONOMY_REMAP_AUTO_RESEED_LIMIT`, `TAXONOMY_REMAP_AUTO_RESEED_COOLDOWN_MINUTES`, `TAXONOMY_REMAP_AUTO_RESEED_RUNNING_STALE_MINUTES`.
