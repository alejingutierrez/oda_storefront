...
- Auth usuarios (Descope): `NEXT_PUBLIC_DESCOPE_PROJECT_ID`, `NEXT_PUBLIC_DESCOPE_BASE_URL`, `DESCOPE_MANAGEMENT_KEY`.
...
npx tsx --tsconfig apps/web/tsconfig.json apps/web/scripts/smoke-product-enrichment.ts  # smoke test de enriquecimiento (OpenAI)
