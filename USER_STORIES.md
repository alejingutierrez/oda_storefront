...
- Estado: **done (2026-02-04) · hardening (2026-02-08, 2026-02-11, 2026-02-23: perfil agresivo + fix parse query params opcionales en `/api/admin/catalog-refresh/cron` + gate 30/10 + backoff exponencial + KPI dual + script de rebaseline metadata + alertas por contexto refresh con campanita y overdue operativo)**.
